...
namespace xUnitTestProject1
{
    public class IntegrateOverTriangleTest
    {
        ...
        public void Test03()
        {
            ...
            Assert.Equal(0.0714286, result, 3);

            //0.14284844932147606
            //0.142857144893951
            var result1 = ni.Integrate(fun, DOP.Quadratic);
            Assert.Equal(0.0714286, result1, 3);


            //0.14282513652961193
            //0.14285561297943772
            var result2 = ni.Integrate(fun, DOP.Cubic);
            Assert.Equal(0.0714286, result2, 4);
        }
        ...
        public void Test04()
        {
            ...
            Assert.Equal(4.85, result, 2);

            //9.76313939042275
            //9.762716330962764
            var result1 = ni.Integrate(fun, DOP.Quadratic);
            Assert.Equal(4.8814, result1, 3);

            //9.76313939042275
            //9.7631365022414958
            var result2 = ni.Integrate(fun, DOP.Cubic);
            Assert.Equal(4.8816, result2, 4);
        }
    }
}